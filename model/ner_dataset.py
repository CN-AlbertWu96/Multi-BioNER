...
class CRFDataset_WC(Dataset):
    ...
    args: 
        ...
        word_forw_index(ins_num, seq_length): index of forward words
    """
    def __init__(self, forw_tensor, forw_index, back_tensor, back_index, word_tensor, label_tensor, mask_tensor, len_tensor, word_forw_index):
        ...
        assert forw_tensor.size(0) == word_forw_index.size(0)
        ...
        self.word_forw_index = word_forw_index

    def __getitem__(self, index):
        return self.forw_tensor[index], self.forw_index[index], self.back_tensor[index], self.back_index[index], self.word_tensor[index], self.label_tensor[index], self.mask_tensor[index], self.len_tensor[index], self.word_forw_index[index]
